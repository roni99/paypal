    ...
    <div class="container">
      ...
      <div class="col-lg-9 col-md-9 col-sm-9">
        <div class="user-login">
          <h1 class="user-login__heading">Change Password
          </h1>
          <form class="form-large" action="javascript:change_pwd();" accept-charset="UTF-8" method="post">
            ...
            <div id="curpwd1" class="err" style="color:#e00000;font-weight:600">
            </div>
            ...
            <div id="newpwd1" class="err" style="font-weight:600;color:#e00000;">
            </div>
            ...
            <div id="conpwd1" class="err" style="font-weight:600;color:#e00000;">
            </div>
