...
<!--<div class="err-msg" id="err_id"><?php echo $msg;?></div>-->
		...
		<form class="form-large" action="signup_add_code.php" accept-charset="UTF-8" method="post">
		<div class="col-lg-6 col-md-6 col-sm-6">
		...
		<div class="col-lg-6 col-md-6 col-sm-6">
		<input type="tel" placeholder="Phone No"   required="required" class="user-login__input user-login__input--tel" name="phone_no" id="phone_no">
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6">
			<input type="password" placeholder="Password" required="required" class="user-login__input user-login__input" name="password" id="password">
		</div>	
