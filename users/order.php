	...
	<input type="text" value="" class="user-login__input user-login__input" id="price" name="price" readonly="readonly">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <select id="time" class="user-login__input user-login__input" required>
          ...
          <option value="1:00 AM">01:00 AM
          </option>
          <option value="2:00 AM">02:00 AM
          </option>
          <option value="3:00 AM">03:00 AM
          </option>
          <option value="4:00 AM">04:00 AM
          </option>
          <option value="5:00 AM">05:00 AM
          </option>
          <option value="6:00 AM">06:00 AM
          </option>
          <option value="7:00 AM">07:00 AM
          </option>
          <option value="8:00 AM">08:00 AM
          </option>
          <option value="9:00 AM">09:00 AM
          </option>
          ...
          <option value="1:00 PM">01:00 PM
          </option>
          <option value="2:00 PM">02:00 PM
          </option>
          <option value="3:00 PM">03:00 PM
          </option>
          <option value="4:00 PM">04:00 PM
          </option>
          <option value="5:00 PM">05:00 PM
          </option>
          <option value="6:00 PM">06:00 PM
          </option>
          <option value="7:00 PM">07:00 PM
          </option>
          <option value="8:00 PM">08:00 PM
          </option>
          <option value="9:00 PM">09:00 PM
          </option>
...
<div class="col-lg-6 col-md-6 col-sm-6 col-md-6 col-sm-6">
        ...
        <textarea id="req" class="user-login__input user-login__input req" required="required">ghg
        </textarea>
      </div>
